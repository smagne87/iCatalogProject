<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<iCatalogSite.Models.CategoryOneModel>" %>
       ...
       .Columns(column =>
           {
               ...
               { %>  
                                    <td><img src="../Content/themes/images/icon_edicion.gif" onclick="editCategory('<%= co.IdCategoryOne  %>')" /></td> <% });
