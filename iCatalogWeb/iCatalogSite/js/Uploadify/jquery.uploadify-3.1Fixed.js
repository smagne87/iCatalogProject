...
(function($) {
			...
			return this.each(function() {
				...
				if (flashInstalled) {
					...
					swfuploadify.queueData = {
						...
						errorMsg           : 'The file type you have selected is not compatible with EyeLink. Supported files are: .doc, .docx, .xls, .xlsx, .pdf, .ePub, .jpeg, .png, .mkv, .m4v, .mov, .mp4'
					};
	...
	var handlers = {
		...
		onDialogOpen : function() {
			...
			this.queueData.errorMsg       = 'The file type you have selected is not compatible with EyeLink. Supported files are: .doc, .docx, .xls, .xlsx, .pdf, .ePub, .jpeg, .png, .mkv, .m4v, .mov, .mp4';
